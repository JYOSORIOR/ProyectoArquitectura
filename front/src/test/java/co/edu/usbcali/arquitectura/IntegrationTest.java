...
import co.edu.usbcali.arquitectura.FrontApp;
import co.edu.usbcali.arquitectura.config.AsyncSyncConfiguration;
...
@SpringBootTest(classes = { FrontApp.class, AsyncSyncConfiguration.class })
