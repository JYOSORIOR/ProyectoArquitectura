...
import { EntityArrayResponseType, CuentaService } from '../service/cuenta.service';
...
export class CuentaComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICuenta): number => this.cuentaService.getCuentaIdentifier(item);
