...
describe('Cuenta Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cuenta', component: CuentaComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to cuentaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCuentaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCuentaIdentifier).toHaveBeenCalledWith(entity);
